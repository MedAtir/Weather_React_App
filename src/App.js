...
import Logo from "./assets/weather-2021-12-07.png";
...
function App() {
  ...
  return (
    <>
      ...
      <footer class="footer fixed-bottom text-center bg-dark p-3  text-light mt-5">
        <Container>2023 - By Med Atir</Container>
      </footer>
    </>
  );
}
